...
#SBATCH --output=/scratch/groups/rbaltman/ziyiw23/EMPROT/logs/preprocess_cluster_ids.log
#SBATCH --error=/scratch/groups/rbaltman/ziyiw23/EMPROT/logs/preprocess_cluster_ids.err
...
echo "🚀 Processing cluster IDs (this will take a while)..."
python scripts/preprocess_cluster_ids.py \
    --data_dir "$DATA_DIR" \
...
echo ""
echo "🎉 Cluster ID preprocessing completed successfully!"
echo ""
...
echo ""
echo "🚀 You can now run training with: bash bash_scripts/train_single_gpu.sh"
